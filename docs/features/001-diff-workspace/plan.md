...
Each slice obeys the `./RULES.md` reviewable-slice rule (one concept, deletes the old path, adds a workspace operation, focused tests, grep proof of decreased scatter).
