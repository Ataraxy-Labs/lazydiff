    ...
    pub(super) fn contextual_command_results(&self) -> Vec<CommandResult> {
        let mut commands = match self.surface {
            ...
            AppSurface::Queue => vec![
                ...
                command_result("account", "sign in", "l", Command::_LoginForge, 6),
                command_result("branch", "pull branch", "p", Command::PullBranch, 7),
                command_result("branch", "push branch", "P", Command::PushBranch, 8),
                command_result("branch", "fetch", "f", Command::FetchBranch, 9),
                command_result(
                    "branch",
                ...
                command_result("data", "refresh", "r", Command::Refresh, 11),
            ],
